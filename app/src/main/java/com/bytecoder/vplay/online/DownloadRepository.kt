package com.bytecoder.vplay.online
...
class DownloadRepository(private val context: Context) {
    ...
    fun enqueue(url: String, title: String = "Media") : Long {
        val req = DownloadManager.Request(Uri.parse(url))
            ...
            .setAllowedOverMetered(!com.bytecoder.vplay.settings.AppSettings.isWifiOnly(context))
            .setAllowedOverRoaming(!com.bytecoder.vplay.settings.AppSettings.isWifiOnly(context))
        if (com.bytecoder.vplay.settings.AppSettings.isWifiOnly(context)) {
